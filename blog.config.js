...
const BLOG = {
  AUTHOR: '21T', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://21t.co', // 网站地址
  KEYWORDS: '博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'b87a88404f874dcfbae12c9114421983?v=9b0ae23278324ece8133dfe1ba42d4e9', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'i@299.ml',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/rptec',
  CONTACT_TELEGRAM: '',
